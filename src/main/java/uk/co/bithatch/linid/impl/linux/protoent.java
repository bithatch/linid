...
public class protoent {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        nss_proto_h.C_POINTER.withName("p_name"),
        nss_proto_h.C_POINTER.withName("p_aliases"),
        nss_proto_h.C_INT.withName("p_proto"),
    ...
    private static final OfInt p_proto$LAYOUT = (OfInt)$LAYOUT.select(groupElement("p_proto"));
     ...
     * }
     */
    public static final OfInt p_proto$layout() {
     ...
     * }
     */
    public static int p_proto(MemorySegment struct) {
     ...
     * }
     */
    public static void p_proto(MemorySegment struct, int fieldValue) {
