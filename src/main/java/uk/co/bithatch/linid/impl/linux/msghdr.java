...
public class msghdr {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        nss_proto_h.C_POINTER.withName("msg_name"),
        nss_proto_h.C_INT.withName("msg_namelen"),
        MemoryLayout.paddingLayout(4),
        nss_proto_h.C_POINTER.withName("msg_iov"),
        nss_proto_h.C_LONG.withName("msg_iovlen"),
        nss_proto_h.C_POINTER.withName("msg_control"),
        nss_proto_h.C_LONG.withName("msg_controllen"),
        nss_proto_h.C_INT.withName("msg_flags"),
        MemoryLayout.paddingLayout(4)
    ).withName("msghdr");
    ...
    private static final OfLong msg_iovlen$LAYOUT = (OfLong)$LAYOUT.select(groupElement("msg_iovlen"));
     ...
     * }
     */
    public static final OfLong msg_iovlen$layout() {
    ...
    private static final OfLong msg_controllen$LAYOUT = (OfLong)$LAYOUT.select(groupElement("msg_controllen"));
     ...
     * }
     */
    public static final OfLong msg_controllen$layout() {
