...
public class sockaddr_in6 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        nss_proto_h.C_SHORT.withName("sin6_family"),
        nss_proto_h.C_SHORT.withName("sin6_port"),
        nss_proto_h.C_INT.withName("sin6_flowinfo"),
        in6_addr.layout().withName("sin6_addr"),
        nss_proto_h.C_INT.withName("sin6_scope_id")
