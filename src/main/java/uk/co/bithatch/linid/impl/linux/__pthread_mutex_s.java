...
public class __pthread_mutex_s {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        nss_proto_h.C_INT.withName("__lock"),
        nss_proto_h.C_INT.withName("__count"),
        nss_proto_h.C_INT.withName("__owner"),
        nss_proto_h.C_INT.withName("__nusers"),
        nss_proto_h.C_INT.withName("__kind"),
        nss_proto_h.C_SHORT.withName("__spins"),
        nss_proto_h.C_SHORT.withName("__elision"),
