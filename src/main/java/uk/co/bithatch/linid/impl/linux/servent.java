...
public class servent {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        nss_proto_h.C_POINTER.withName("s_name"),
        nss_proto_h.C_POINTER.withName("s_aliases"),
        nss_proto_h.C_INT.withName("s_port"),
        MemoryLayout.paddingLayout(4),
        nss_proto_h.C_POINTER.withName("s_proto")
    ).withName("servent");
    ...
    private static final OfInt s_port$LAYOUT = (OfInt)$LAYOUT.select(groupElement("s_port"));
     ...
     * }
     */
    public static final OfInt s_port$layout() {
        return s_port$LAYOUT;
    }

    private static final long s_port$OFFSET = 16;
     ...
     * }
     */
    public static int s_port(MemorySegment struct) {
     ...
     * }
     */
    public static void s_port(MemorySegment struct, int fieldValue) {
    ...
    private static final long s_proto$OFFSET = 24;
